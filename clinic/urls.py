...
urlpatterns = [
    ...
    path("patients/add/", views.add_or_edit_patient, name="add_patient"),
    path("patients/<int:pk>/edit/", views.add_or_edit_patient, name="edit_patient"),
    path("patients/", views.patient_list, name="patient_list"),
    ...
    path("borxhet/",views.debt_report, name="debt_report"),
